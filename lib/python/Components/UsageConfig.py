...
def InitUsageConfig():
	...
	for i in list(range(100, 1300, 100)):
	...
	config.usage.show_infobar_channel_number = ConfigYesNo(default = False)
	config.usage.show_second_infobar = ConfigSelection(default = "1", choices = [("0", _("Off")), ("1", _("Event Info")), ("2", _("2nd Infobar INFO"))])
	...
	config.usage.serviceitems_per_page = ConfigSelectionNumber(default = 10, stepwidth = 1, min = 8, max = 40, wraparound = True)
	...
	config.usage.show_channel_jump_in_servicelist = ConfigSelection(default="Alpha", choices = [
					("alpha", _("Alpha")),
					("number", _("Number"))])
	channelpluginlist = [("Playlist", _("Playlist")), ("MovieBrowser", _("MovieBrowser")), ("Mediaportal", _("MediaPortal")), ("IPTVPlayer", _("Iptvplayer")), ("BMC", _("BMC")), ("Youtube", _("Youtube")), ("MP3Browser", _("MP3Browser")), ("WebradioFS", _("WebradioFS")), ("TSMedia", _("TSmedia"))]
	...
	channelpluginlist1 = [("Playlist", _("Playlist")), ("MovieBrowser", _("MovieBrowser")), ("Mediaportal", _("MediaPortal")), ("IPTVPlayer", _("Iptvplayer")), ("BMC", _("BMC")), ("Youtube", _("Youtube")), ("MP3Browser", _("MP3Browser")), ("WebradioFS", _("WebradioFS")), ("TSMedia", _("TSmedia"))]
	if getBoxType() in ('ax51', 'formuler1', 'mutant2400', 'mutant51', 'osmega', 'quadbox2400', 'triplex', 'vuduo2', 'vusolo2', 'vusolo4k', 'vusolose', 'vuultimo4k', 'sf4008'):
	...
	channelpluginlist2 = [("Playlist", _("Playlist")), ("MovieBrowser", _("MovieBrowser")), ("Mediaportal", _("MediaPortal")), ("IPTVPlayer", _("Iptvplayer")), ("BMC", _("BMC")), ("Youtube", _("Youtube")), ("MP3Browser", _("MP3Browser")), ("WebradioFS", _("WebradioFS")), ("TSMedia", _("TSmedia"))]
	if getBoxType() in ('ax51', 'formuler1', 'mutant2400', 'mutant51', 'osmega', 'quadbox2400', 'triplex', 'vuduo2', 'vusolo2', 'vusolo4k', 'vusolose', 'vuultimo4k', 'sf4008'):
	...
	channelpluginlist3 = [("Playlist", _("Playlist")), ("MovieBrowser", _("MovieBrowser")), ("Mediaportal", _("MediaPortal")), ("IPTVPlayer", _("Iptvplayer")), ("BMC", _("BMC")), ("Youtube", _("Youtube")), ("MP3Browser", _("MP3Browser")), ("WebradioFS", _("WebradioFS")), ("TSMedia", _("TSmedia"))]
	if getBoxType() in ('ax51', 'formuler1', 'mutant2400', 'mutant51', 'osmega', 'quadbox2400', 'triplex', 'vuduo2', 'vusolo2', 'vusolo4k', 'vusolose', 'vuultimo4k', 'sf4008'):
					channelpluginlist2.append(("Kodi", _("Kodi")))       	                                        
