...
class InfoBarEPG:
	...
	def showCoolTVGuide(self):
		if self.servicelist is None:
			return
		if fileExists("/usr/lib/enigma2/python/Plugins/Extensions/CoolTVGuide/plugin.pyc*"):
		...
		if not self.LongButtonPressed:
			try:
				...
				if self.session.pipshown:
					...
					if int(xres) <= 720 or about.getCPUString() == 'BCM7346B2' or about.getCPUString() == 'BCM7425B2' or about.getCPUString() == 'BCM7429B0' or getBoxType() in ('vusolo4k', 'mutant51', 'mutant60', 'sf4008', 'sf5008', 'sf8008', 'sf8008m', 'ax51', 'ax60', 'ax61', 'gbquad4k', 'gbue4k', 'e4hdultra', 'zgemmah7', 'zgemmah9combo', 'zgemmah9twin', 'zgemmah9s'):
