...
#		menu = self["Mlist"].getCurrent()
		...
		if menu == "Extras":
			...
			if fileExists("/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/PluginReLoad.pyc") or fileExists("/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/PluginReLoad.pyc"):
