...
config.defaultskinSetup.steps = ConfigSelection([('default Opennfr',_("default Opennfr")),('default Utopia',_("default Utopia"))])
if config.defaultskinSetup.steps.value == "default Utopia":
	DEFAULT_SKIN = "NFR_Skin/skin.xml"
elif config.defaultskinSetup.steps.value == "default Opennfr":
